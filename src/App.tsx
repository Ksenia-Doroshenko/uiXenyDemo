...
function App() {
  ...
  return (
    <>
      <div className="wrap" style={{ display: "grid", justifyItems: "center", padding: "20px", fontFamily: "sans-serif"}}>

        <p style={{ textAlign: "center", width: "50%", fontFamily: "sans-serif", fontSize: "32px", fontWeight: "bold" }}>Кнопки</p>

        <div className="container" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", width: "50%", justifyItems: "center", padding: "20px" }}>
          ...
          <div className="wrap" style={{ display: "grid", gridArea: "4 / 1 / 4 / 4", width: "100%", justifyItems: "center" }}>
          ...
          <div className="wrap" style={{ display: "grid",  overflow: "visible", width: "100%", gridArea: "5 / 1 / 5 / 4", justifyItems: "left" }}>
            <p style={{ fontFamily: "sans-serif", fontSize: "32px", fontWeight: "bold", justifySelf: "center"}}>CheckBoxes</p>
            ...
            <CheckBox type="checkmark" defaultChecked={true} disabled={true}>CheckBox--checkmark checked disabled</CheckBox>
            <br/>
            <CheckBox type="checkmark--filled" defaultChecked={true}>CheckBox--checkmark--filled checked</CheckBox>
            <CheckBox type="checkmark--filled" defaultChecked={true} disabled={true} >CheckBox--checkmark--filled checked disabled</CheckBox>
